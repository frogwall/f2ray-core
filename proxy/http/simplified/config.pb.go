...
const file_proxy_http_simplified_config_proto_rawDesc = "" +
	...
	"$com.v2ray.core.proxy.http.simplifiedP\x01Z4github.com/frogwall/v2ray-core/v5/proxy/http/simplified\xaa\x02 V2Ray.Core.Proxy.Http.Simplifiedb\x06proto3"

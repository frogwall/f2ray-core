...
const file_proxy_naive_simplified_config_proto_rawDesc = "" +
	...
	"%com.v2ray.core.proxy.naive.simplifiedP\x01Z5github.com/v2fly/v2ray-core/v5/proxy/naive/simplified\xaa\x02!V2Ray.Core.Proxy.Naive.Simplifiedb\x06proto3"

...
func (a *Account) Equals(other protocol.Account) bool {
	if otherAccount, ok := other.(*Account); ok {
		return a.Username == otherAccount.Username && a.Password == otherAccount.Password
	}
	return false
}
...
const file_proxy_naive_config_proto_rawDesc = "" +
	...
	"\x1acom.v2ray.core.proxy.naiveP\x01Z*github.com/v2fly/v2ray-core/v5/proxy/naive\xaa\x02\x16V2Ray.Core.Proxy.Naiveb\x06proto3"

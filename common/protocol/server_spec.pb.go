...
type ServerEndpoint struct {
	...
	Method        string                 `protobuf:"bytes,4,opt,name=method,proto3" json:"method,omitempty"` // tcp, ws, wss, quic - for brook protocol
...
func (x *ServerEndpoint) GetMethod() string {
	if x != nil {
		return x.Method
	}
	return ""
...
const file_common_protocol_server_spec_proto_rawDesc = "" +
	"\n" +
	"!common/protocol/server_spec.proto\x12\x1av2ray.core.common.protocol\x1a\x18common/net/address.proto\x1a\x1acommon/protocol/user.proto\"\xaf\x01\n" +
	...
	"\x04user\x18\x03 \x03(\v2 .v2ray.core.common.protocol.UserR\x04user\x12\x16\n" +
	"\x06method\x18\x04 \x01(\tR\x06methodBo\n" +
	"\x1ecom.v2ray.core.common.protocolP\x01Z.github.com/frogwall/v2ray-core/v5/common/protocol\xaa\x02\x1aV2Ray.Core.Common.Protocolb\x06proto3"

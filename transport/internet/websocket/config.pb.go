...
const file_transport_internet_websocket_config_proto_rawDesc = "" +
	...
	"+com.v2ray.core.transport.internet.websocketP\x01Z;github.com/frogwall/v2ray-core/v5/transport/internet/websocket\xaa\x02'V2Ray.Core.Transport.Internet.Websocketb\x06proto3"

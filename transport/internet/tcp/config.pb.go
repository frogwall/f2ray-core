...
const file_transport_internet_tcp_config_proto_rawDesc = "" +
	...
	"%com.v2ray.core.transport.internet.tcpP\x01Z5github.com/frogwall/v2ray-core/v5/transport/internet/tcp\xaa\x02!V2Ray.Core.Transport.Internet.Tcpb\x06proto3"

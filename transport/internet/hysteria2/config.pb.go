...
type Config struct {
	...
	FastOpen              bool                   `protobuf:"varint,7,opt,name=fast_open,json=fastOpen,proto3" json:"fast_open,omitempty"`
	// Obfuscation configuration
	Obfs          *ObfuscationConfig `protobuf:"bytes,8,opt,name=obfs,proto3" json:"obfs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Config) GetFastOpen() bool {
	if x != nil {
		return x.FastOpen
	}
	return false
...
func (x *Config) GetObfs() *ObfuscationConfig {
	if x != nil {
		return x.Obfs
	}
	return nil
...
type ObfuscationConfig struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          string                 `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`         // "salamander" or "none"
	Password      string                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // obfs-password
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ObfuscationConfig) Reset() {
	*x = ObfuscationConfig{}
...
func (x *ObfuscationConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObfuscationConfig) ProtoMessage() {}

func (x *ObfuscationConfig) ProtoReflect() protoreflect.Message {
	mi := &file_transport_internet_hysteria2_config_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObfuscationConfig.ProtoReflect.Descriptor instead.
func (*ObfuscationConfig) Descriptor() ([]byte, []int) {
	return file_transport_internet_hysteria2_config_proto_rawDescGZIP(), []int{2}
}

func (x *ObfuscationConfig) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *ObfuscationConfig) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
const file_transport_internet_hysteria2_config_proto_rawDesc = "" +
	...
	"\tdown_mbps\x18\x03 \x01(\x04R\bdownMbps\"\xca\x02\n" +
	"\x06Config\x12S\n" +
	"\n" +
	...
	"\x11use_udp_extension\x18\x06 \x01(\bR\x0fuseUdpExtension\x12\x1b\n" +
	"\tfast_open\x18\a \x01(\bR\bfastOpen\x12N\n" +
	"\x04obfs\x18\b \x01(\v2:.v2ray.core.transport.internet.hysteria2.ObfuscationConfigR\x04obfs:\x1a\x82\xb5\x18\x16\n" +
	"\ttransport\x12\thysteria2\"C\n" +
	"\x11ObfuscationConfig\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpasswordBw\n" +
	"+com.v2ray.core.transport.internet.hysteria2P\x01Z\x1ctransport/internet/hysteria2\xaa\x02'V2Ray.Core.Transport.Internet.Hysteria2b\x06proto3"
...
var file_transport_internet_hysteria2_config_proto_goTypes = []any{
	...
	(*ObfuscationConfig)(nil), // 2: v2ray.core.transport.internet.hysteria2.ObfuscationConfig
}
var file_transport_internet_hysteria2_config_proto_depIdxs = []int32{
	...
	2, // 1: v2ray.core.transport.internet.hysteria2.Config.obfs:type_name -> v2ray.core.transport.internet.hysteria2.ObfuscationConfig

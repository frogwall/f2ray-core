...
const file_transport_internet_kcp_config_proto_rawDesc = "" +
	...
	"B\x84\x01\n" +
	"%com.v2ray.core.transport.internet.kcpP\x01Z5github.com/frogwall/v2ray-core/v5/transport/internet/kcp\xaa\x02!V2Ray.Core.Transport.Internet.Kcpb\x06proto3"

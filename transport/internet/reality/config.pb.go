...
type Config struct {
	...
	PublicKey     []byte                 `protobuf:"bytes,2,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"` // X25519 public key bytes
...
const file_transport_internet_reality_config_proto_rawDesc = "" +
	"\n" +
	"'transport/internet/reality/config.proto\x12%v2ray.core.transport.internet.reality\"\xb4\x01\n" +
	"\x06Config\x12\x1f\n" +
	...
	"\bspider_x\x18\x06 \x01(\tR\aspiderXB\x93\x01\n" +

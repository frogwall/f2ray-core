...
const file_transport_internet_request_stereotype_meek_config_proto_rawDesc = "" +
	...
	"\ttransport\x12\x04meek\x90\xff)\x01B\xc3\x01\n" +
	"9com.v2ray.core.transport.internet.request.stereotype.meekP\x01ZLgithub.com/frogwall/f2ray-core/v5/transport/internet/request/stereotype/meek\xaa\x025V2Ray.Core.Transport.Internet.Request.Stereotype.Meekb\x06proto3"
